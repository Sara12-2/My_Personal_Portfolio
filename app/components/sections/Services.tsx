...
const services = [
  ...
  {
    id: 8,
    title: 'Full Stack Web Apps (Node.js)',
    description: 'Scalable web applications with Node.js, Express, and MongoDB/PostgreSQL. RESTful APIs, JWT authentication, and cloud deployment ready.',
    icon: Terminal,
    color: '#22C55E',
    gradient: 'from-[#22C55E]/20 to-[#22C55E]/5',
        ...
        >
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-[#4A4A4A] mt-4 max-w-2xl mx-auto text-lg">
              Portfolio Design • Dashboards • Full Stack • AI/ML • Chatbots • Landing Pages
            </p>
          </div>
